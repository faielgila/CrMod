...
public class BlockBeCuBlock extends CrmodModElements.ModElement {
	@ObjectHolder("crmod:block_be_cu")
	public static final Block block = null;
	public BlockBeCuBlock(CrmodModElements instance) {
		super(instance, 19);
	}
