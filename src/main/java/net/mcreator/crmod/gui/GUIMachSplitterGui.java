...
public class GUIMachSplitterGui extends CrmodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GUIMachSplitterGui(CrmodModElements instance) {
		super(instance, 229);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("guimachsplitter"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("crmod:textures/guimachsplitter.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float partialTicks, int gx, int gy) {
			...
			this.blit(this.guiLeft + 24, this.guiTop + 29, 0, 0, 256, 256, 256, 256);
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Atomic Splitter", 6, 11, -12566464);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 114, this.guiTop + 56, 54, 20, "Process", e -> {
				if (true) {
