...
public class IngotBeCuItem extends CrmodModElements.ModElement {
	@ObjectHolder("crmod:ingot_be_cu")
	public static final Item block = null;
	public IngotBeCuItem(CrmodModElements instance) {
		super(instance, 42);
	}
