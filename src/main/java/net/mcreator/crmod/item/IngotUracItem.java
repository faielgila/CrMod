...
public class IngotUracItem extends CrmodModElements.ModElement {
	@ObjectHolder("crmod:ingoturac")
	public static final Item block = null;
	public IngotUracItem(CrmodModElements instance) {
		super(instance, 64);
	}
