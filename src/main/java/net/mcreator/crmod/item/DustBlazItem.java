...
public class DustBlazItem extends CrmodModElements.ModElement {
	@ObjectHolder("crmod:dustblaz")
	public static final Item block = null;
	public DustBlazItem(CrmodModElements instance) {
		super(instance, 38);
	}
