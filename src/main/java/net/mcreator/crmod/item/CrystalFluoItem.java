...
public class CrystalFluoItem extends CrmodModElements.ModElement {
	@ObjectHolder("crmod:crystal_fluo")
	public static final Item block = null;
	public CrystalFluoItem(CrmodModElements instance) {
		super(instance, 47);
	}
