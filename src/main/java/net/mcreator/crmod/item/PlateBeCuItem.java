...
public class PlateBeCuItem extends CrmodModElements.ModElement {
	@ObjectHolder("crmod:plate_be_cu")
	public static final Item block = null;
	public PlateBeCuItem(CrmodModElements instance) {
		super(instance, 44);
	}
